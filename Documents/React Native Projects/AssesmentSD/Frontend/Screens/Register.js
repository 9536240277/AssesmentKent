    ...
    if (email !== "" && password !== "") {
      ...
      if (email !== "" && password !== "") {
        ...
        const params = JSON.stringify({
          ...
          axios.post("http://192.168.1.30:3306/createUser", params,{
    ...
    <>
      ...
      <Image
        ...
        <Text style={styles.description}>
          For any issues in Registration please reach our contact support.
        </Text>
        ...
        <Check title={"Register"} onPress={onHandleSignIn}></Check>
